...
var _src_Runner = {};
var _src_parsers_MdParser = {};
var _src_runners_JsRunner = {};
var _src_runners_JsonRunner = {};
var _src_runners_ShellRunner = {};
var _src_runners_YmlRunner = {};
var _src_runners_generic_ModelRunner = {};
var _src_runners_generic_ScriptRunner = {};
var _src_util_code = {};
var _src_util_log = {};
var _src_util_object = {};
var _src_util_string = {};
...
(function () {
    ...
    var define = null;
    var exports = _node_modules_appcfg_lib_appcfg != null ? _node_modules_appcfg_lib_appcfg : {};
...
;
    ...
    if (_node_modules_appcfg_lib_appcfg === module.exports) {
        // do nothing if
    } else if (__isObj(_node_modules_appcfg_lib_appcfg) && __isObj(module.exports)) {
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_util_string != null ? _src_util_string : {};
    var module = { exports: exports };

    "use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.str_interpolate = void 0;
var atma_utils_1 = require("atma-utils");
var log_1 = _src_util_log;
function str_interpolate(str, env, root, isOptional) {
    var _a, _b, _c;
    ...
    do {
        ...
        if (str[i + 1] === '{') {
            ...
            if ($exp.includes(':')) {
                var i_1 = $exp.indexOf(':');
                $exp = $exp.substring(0, i_1).trim();
                $default = $exp.substring(i_1 + 1).trim();
            }
            start = i = end;
        }
        else {
            var rgx = /[^\w_]/g;
            rgx.lastIndex = i + 1;
            var end = (_b = (_a = rgx.exec(str)) === null || _a === void 0 ? void 0 : _a.index) !== null && _b !== void 0 ? _b : str.length;
            $exp = str.substring(i + 1, end);
            start = i = end;
        }
        if ($exp) {
            var val = (_c = (0, atma_utils_1.obj_getProperty)(env, $exp)) !== null && _c !== void 0 ? _c : (0, atma_utils_1.obj_getProperty)(root, $exp);
            if (val != null) {
                out += val;
            }
            else {
                (0, log_1.log_warn)('<config: obj_interpolate: property not exists in root', $exp);
            }
        }
    } while (true);
...
exports.str_interpolate = str_interpolate;
;
;
    ...
    if (_src_util_string === module.exports) {
        // do nothing if
    } else if (__isObj(_src_util_string) && __isObj(module.exports)) {
        Object.assign(_src_util_string, module.exports);
    } else {
        _src_util_string = module.exports;
    }
...
exports.obj_ensureProperty = obj_ensureProperty;
;
function obj_interpolate(obj, env, root, isOptional) {
    obj_visitStrings(obj, function (str, key, parent) {
        return (0, string_1.str_interpolate)(str, env, root);
    });
    return obj;
}
exports.obj_interpolate = obj_interpolate;
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_runners_generic_ModelRunner != null ? _src_runners_generic_ModelRunner : {};
    var module = { exports: exports };
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ModelRunner = void 0;
var object_1 = _src_util_object;
var ModelRunner = /** @class */ (function () {
    function ModelRunner() {
    }
    ModelRunner.prototype.preRun = function (data) {
    ...
    ModelRunner.prototype.postRun = function (result, logs, data) {
        return __awaiter(this, void 0, Promise, function () {
            var json;
            return __generator(this, function (_a) {
                json = (0, object_1.obj_interpolate)(result, data.env, data.config);
                (0, object_1.obj_deepExtend)(data.env, json);
...
;
    ...
    if (_src_runners_generic_ModelRunner === module.exports) {
        // do nothing if
    } else if (__isObj(_src_runners_generic_ModelRunner) && __isObj(module.exports)) {
        Object.assign(_src_runners_generic_ModelRunner, module.exports);
    } else {
        _src_runners_generic_ModelRunner = module.exports;
    }
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_runners_JsonRunner != null ? _src_runners_JsonRunner : {};
    var module = { exports: exports };
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.JsonRunner = void 0;
var ModelRunner_1 = _src_runners_generic_ModelRunner;
var JsonRunner = /** @class */ (function (_super) {
    __extends(JsonRunner, _super);
    function JsonRunner() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.type = 'json';
        _this.extensions = ['json'];
        return _this;
    }
    JsonRunner.prototype.run = function (data) {
        return JSON.parse(data.content);
    };
    return JsonRunner;
}(ModelRunner_1.ModelRunner));
...
;
    ...
    if (_src_runners_JsonRunner === module.exports) {
        // do nothing if
    } else if (__isObj(_src_runners_JsonRunner) && __isObj(module.exports)) {
        Object.assign(_src_runners_JsonRunner, module.exports);
    } else {
        _src_runners_JsonRunner = module.exports;
    }
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_runners_YmlRunner != null ? _src_runners_YmlRunner : {};
    var module = { exports: exports };
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.YmlRunner = void 0;
var yml = require("yamljs");
var ModelRunner_1 = _src_runners_generic_ModelRunner;
var YmlRunner = /** @class */ (function (_super) {
    __extends(YmlRunner, _super);
    function YmlRunner() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.type = 'json';
        _this.extensions = ['yml', 'yaml'];
        return _this;
    }
    YmlRunner.prototype.run = function (data) {
        return __awaiter(this, void 0, Promise, function () {
            var json;
            return __generator(this, function (_a) {
                data.content = data.content.replace(/\t/g, '  ');
                json = yml.parse(data.content);
                return [2 /*return*/, { result: json, logs: [] }];
            });
        });
    };
    return YmlRunner;
}(ModelRunner_1.ModelRunner));
exports.YmlRunner = YmlRunner;
;

    function __isObj(x) {
        return x != null && typeof x === 'object' && x.constructor === Object;
    }
    if (_src_runners_YmlRunner === module.exports) {
        // do nothing if
    } else if (__isObj(_src_runners_YmlRunner) && __isObj(module.exports)) {
        Object.assign(_src_runners_YmlRunner, module.exports);
    } else {
        _src_runners_YmlRunner = module.exports;
    }
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_runners_generic_ScriptRunner != null ? _src_runners_generic_ScriptRunner : {};
    var module = { exports: exports };
...
var ScriptRunner = /** @class */ (function () {
    ...
    ScriptRunner.prototype.preRun = function (data) {
        return __awaiter(this, void 0, Promise, function () {
            var str;
            return __generator(this, function (_a) {
                str = data.content;
                data.content = (0, string_1.str_interpolate)(str, data.env, data.config);
                return [2 /*return*/, str];
            });
        });
    };
    ScriptRunner.prototype.postRun = function (result, logs, data) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, null];
            });
...
;
    ...
    if (_src_runners_generic_ScriptRunner === module.exports) {
        // do nothing if
    } else if (__isObj(_src_runners_generic_ScriptRunner) && __isObj(module.exports)) {
        Object.assign(_src_runners_generic_ScriptRunner, module.exports);
    } else {
        _src_runners_generic_ScriptRunner = module.exports;
    }
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_runners_ShellRunner != null ? _src_runners_ShellRunner : {};
    var module = { exports: exports };
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ShellRunner = void 0;
var ScriptRunner_1 = _src_runners_generic_ScriptRunner;
var shellbee_1 = require("shellbee");
var sshly_1 = require("sshly");
var alot_1 = require("alot");
var ShellRunner = /** @class */ (function (_super) {
    __extends(ShellRunner, _super);
    function ShellRunner() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.type = 'shell';
        _this.extensions = ['sh', 'bash', 'shell'];
        return _this;
    }
    ShellRunner.prototype.run = function (data, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var content, env, config, commands;
            return __generator(this, function (_a) {
                content = data.content, env = data.env, config = data.config;
                commands = Script.splitCommands(Script.splitLines(content));
                if (env.ssh) {
                    return [2 /*return*/, Runner.ssh(commands, __assign({ ssh: env.ssh }, (opts !== null && opts !== void 0 ? opts : {})))];
                }
                return [2 /*return*/, Runner.local(commands, opts)];
            });
        });
    };
    return ShellRunner;
}(ScriptRunner_1.ScriptRunner));
exports.ShellRunner = ShellRunner;
var Runner;
(function (Runner) {
    function local(commands, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var results;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, alot_1.default)(commands).mapAsync(function (command) { return __awaiter(_this, void 0, void 0, function () {
                            var start, shell, _a, std, stdout, stderr;
                            var _b;
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        start = Date.now();
                                        shell = new shellbee_1.Shell({
                                            command: command,
                                            silent: true,
                                        });
                                        (_b = opts === null || opts === void 0 ? void 0 : opts.onLog) === null || _b === void 0 ? void 0 : _b.call(opts, "Execute shell-command: ".concat(/[^\n]+/.exec(command)[0]));
                                        shell
                                            .on('process_stdout', function (data) { var _a; return (_a = opts === null || opts === void 0 ? void 0 : opts.onLog) === null || _a === void 0 ? void 0 : _a.call(opts, data.buffer.toString()); })
                                            .on('process_stderr', function (data) { var _a; return (_a = opts === null || opts === void 0 ? void 0 : opts.onLog) === null || _a === void 0 ? void 0 : _a.call(opts, data.buffer.toString()); });
                                        return [4 /*yield*/, shell.run()];
                                    case 1:
                                        _a = _c.sent(), std = _a.std, stdout = _a.stdout, stderr = _a.stderr;
                                        return [2 /*return*/, {
                                                time: Date.now() - start,
                                                command: command,
                                                stdout: stdout,
                    ...
                    case 1:
                        results = _a.sent();
                        return [2 /*return*/, { logs: results }];
                }
            });
        });
    }
    Runner.local = local;
    function ssh(commands, opts) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var client, _i, commands_1, command;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        client = new sshly_1.Ssh(__assign({}, opts.ssh));
                        _i = 0, commands_1 = commands;
                        _b.label = 1;
                    case 1:
                        if (!(_i < commands_1.length)) return [3 /*break*/, 4];
                        command = commands_1[_i];
                        (_a = opts === null || opts === void 0 ? void 0 : opts.onLog) === null || _a === void 0 ? void 0 : _a.call(opts, "Execute shell-command: ".concat(/[^\n]+/.exec(command)[0]));
                        return [4 /*yield*/, client.exec(command)];
                    case 2:
                        _b.sent();
                        _b.label = 3;
                    case 3:
...
(function (Script) {
    function splitLines(script) {
        ...
        var count = /\s+/.exec(lines[0])[0].length;
        var rgx = new RegExp("^\\s{0,".concat(count, "}"), 'i');
        lines = lines.map(function (line) { return line.replace(rgx, ''); });
        return lines;
    }
    Script.splitLines = splitLines;
    function splitCommands(lines) {
        var commands = [];
        for (var i = 0; i < lines.length; i++) {
            ...
            if (line.endsWith('\\')) {
                ...
                commands.push(lines.slice(i, j).join('\n'));
                i = j - 1;
                continue;
            }
            if (/<<EOT/.test(line)) {
                ...
                for (; j < lines.length; j++) {
                    var line_2 = lines[j];
                    if (/EOT/.test(line_2) === false) {
                        continue;
                    }
                    break;
                }
                commands.push(lines.slice(i, j + 1).join('\n'));
                i = j;
                continue;
            }
            commands.push(line);
    ...
    Script.splitCommands = splitCommands;
})(Script || (Script = {}));
;
    ...
    if (_src_runners_ShellRunner === module.exports) {
        // do nothing if
    } else if (__isObj(_src_runners_ShellRunner) && __isObj(module.exports)) {
        Object.assign(_src_runners_ShellRunner, module.exports);
    } else {
        _src_runners_ShellRunner = module.exports;
    }
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_util_code != null ? _src_util_code : {};
    var module = { exports: exports };
...
(function ($code) {
    function extractDependencies(code) {
        var imports = getRgxMatches(code, /^\s*import.+?from\s+['"](?<path>[^'"]+)['"]/gm);
        var requires = getRgxMatches(code, /\brequire\s*\(\s*['"](?<path>[^'"]+)['"]\s*\)/g);
        var paths = __spreadArray(__spreadArray([], imports.map(function (x) { return x.groups.path; }), true), requires.map(function (x) { return x.groups.path; }), true);
        return paths;
    }
    $code.extractDependencies = extractDependencies;
    function getRgxMatches(str, rgx) {
        var matches = [];
        while (true) {
...
;
    ...
    if (_src_util_code === module.exports) {
        // do nothing if
    } else if (__isObj(_src_util_code) && __isObj(module.exports)) {
        Object.assign(_src_util_code, module.exports);
    } else {
        _src_util_code = module.exports;
    }
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_runners_JsRunner != null ? _src_runners_JsRunner : {};
    var module = { exports: exports };
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.JsRunner = void 0;
var ScriptRunner_1 = _src_runners_generic_ScriptRunner;
var vm = require("vm");
var code_1 = _src_util_code;
var alot_1 = require("alot");
var shellbee_1 = require("shellbee");
var JsRunner = /** @class */ (function (_super) {
    ...
    function JsRunner() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.type = 'script';
        _this.extensions = ['js', 'javascript'];
        _this.global = Object.create(global);
        return _this;
    }
    JsRunner.prototype.run = function (data) {
        return __awaiter(this, void 0, Promise, function () {
            var code, script, $console, $ctx, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        code = "\n            ".concat(data.content, "\n        ");
                        script = new vm.Script(code, { filename: data.ctx.filename });
                        Object.assign(this.global, data.env);
                        $console = new Console();
                        this.global.console = $console;
                        return [4 /*yield*/, this.ensureDependencies($console, code)];
                    case 1:
                        _a.sent();
                        $ctx = vm.createContext(this.global);
                        $ctx.env = process.env;
                        result = script.runInContext($ctx);
                        if (!(result && typeof result.then === 'function')) return [3 /*break*/, 3];
    ...
    JsRunner.prototype.ensureDependencies = function ($console, code) {
        return __awaiter(this, void 0, void 0, function () {
            var modules, notResolved, modulesToInstall;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        modules = code_1.$code.extractDependencies(code);
                        return [4 /*yield*/, (0, alot_1.default)(modules)
                                .filterAsync(function (name) { return __awaiter(_this, void 0, void 0, function () {
                                var error_1;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                        ...
                                        case 1:
                                            _a.trys.push([1, 3, , 4]);
                                            return [4 /*yield*/, Promise.resolve().then(function () { return require(name); })];
                                        case 2:
                                            _a.sent();
                                            // exists
                                            return [2 /*return*/, false];
                    ...
                    case 1:
                        ...
                        modulesToInstall = notResolved.join(' ');
                        $console.log("Installing ".concat(modulesToInstall));
                        return [4 /*yield*/, (0, shellbee_1.run)("npm i ".concat(modulesToInstall))];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
...
;
    ...
    if (_src_runners_JsRunner === module.exports) {
        // do nothing if
    } else if (__isObj(_src_runners_JsRunner) && __isObj(module.exports)) {
        Object.assign(_src_runners_JsRunner, module.exports);
    } else {
        _src_runners_JsRunner = module.exports;
    }
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_parsers_MdParser != null ? _src_parsers_MdParser : {};
    var module = { exports: exports };

    "use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.MdParser = void 0;
var MdParser = /** @class */ (function () {
    function MdParser() {
    }
    // split content into h1, and script blocks
    MdParser.prototype.split = function (content) {
        ...
        for (var i = 0; i < lines.length; i++) {
            ...
            text = [];
            if (type === 'h1') {
                var block = Lines.getSingleLineBlock('h1', lines, i);
                blocks.push(block);
                continue;
            }
            if (type === 'code') {
                var _a = Lines.getCode(lines, i), index = _a.index, block = _a.block;
                i = index;
                blocks.push(block);
                continue;
            }
...
(function (Blocks) {
    ...
    Blocks.addText = addText;
})(Blocks || (Blocks = {}));
var Lines;
(function (Lines) {
    var h1 = /^\s*#{1}\s*(?<text>[^#].+)$/;
    var code = /^\s*(?<block>`{3,})(?<lang>\w+)\s*$/;
    var rgxes = { 'h1': h1 };
    function type(line) {
        if (h1.test(line)) {
            return 'h1';
    ...
    Lines.type = type;
    function getSingleLineBlock(type, lines, idx) {
        var rgx = rgxes[type];
        if (rgx == null) {
            throw new Error("Invalid single line type: ".concat(type));
        }
        var line = lines[idx];
        var text = rgx.exec(line).groups.text;
        return {
            type: type,
            content: text
        };
    }
    Lines.getSingleLineBlock = getSingleLineBlock;
    function getCode(lines, idx) {
        var match = code.exec(lines[idx]);
        var count = match.groups.block.length;
        var rgx = new RegExp("^s*(".concat(''.padStart(count, '`'), ")($|[^`])"));
        var i = idx + 1;
        for (; i < lines.length; i++) {
            var isEnd = rgx.test(lines[i]);
            if (isEnd) {
                break;
            }
        }
...
;
    ...
    if (_src_parsers_MdParser === module.exports) {
        // do nothing if
    } else if (__isObj(_src_parsers_MdParser) && __isObj(module.exports)) {
        Object.assign(_src_parsers_MdParser, module.exports);
    } else {
        _src_parsers_MdParser = module.exports;
    }
...
var appcfg_1 = _node_modules_appcfg_lib_appcfg;
var atma_io_1 = require("atma-io");
var JsonRunner_1 = _src_runners_JsonRunner;
var YmlRunner_1 = _src_runners_YmlRunner;
var ShellRunner_1 = _src_runners_ShellRunner;
var JsRunner_1 = _src_runners_JsRunner;
var MdParser_1 = _src_parsers_MdParser;
var Runner = /** @class */ (function () {
    function Runner() {
        this.ctx = {};
    }
    Runner.prototype.config = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Runner.prototype.runFromCli = function () {
        return __awaiter(this, void 0, void 0, function () {
            var config, path, sections, run;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.config()];
                    case 1:
                        config = _a.sent();
                        path = config.$cli.args[0];
                        if (path == null || path === '') {
                            throw new Error("Markdown file not provided. Example: \"mdrun foo.md\"");
                        }
                        sections = [];
                        run = config.$cli.params.run;
                        if (run) {
                            sections = run.split(/[;,]/g).map(function (x) { return x.trim(); });
                        }
                        return [4 /*yield*/, this.executeFile(path, {
                                sections: sections,
                                onLog: function (log) {
                                    console.log(log);
                                }
    ...
    Runner.prototype.executeFile = function (path, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var file, md, parser, blocks, labels, i, block, name, allowed, nextH1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        if ((_a.sent()) === false) {
                            throw new Error("File \"".concat(file.uri.toLocalFile(), "\" not found"));
                        }
                        return [4 /*yield*/, file.readAsync()];
                    case 2:
                        md = _a.sent();
                        parser = new MdParser_1.MdParser();
                        blocks = parser.split(md);
                        if ((opts === null || opts === void 0 ? void 0 : opts.sections) && (opts === null || opts === void 0 ? void 0 : opts.sections.length) > 0) {
                            labels = opts.sections;
                            for (i = 0; i < blocks.length; i++) {
                                ...
                                allowed = labels.includes(name);
                                if (allowed === false) {
                                    nextH1 = blocks.findIndex(function (x) { return x.type === 'h1'; }, i + 1);
                        ...
                        return [4 /*yield*/, this.executeBlocks(blocks, opts)];
                    case 3: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    Runner.prototype.executeBlocks = function (blocks, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var config, env, executables, logEntries, i, block, lang, content, runner, data, startedAt, _a, result, logs;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.config()];
                    case 1:
                        config = _b.sent();
                        env = config.toJSON();
                        executables = blocks.filter(function (x) { return x.type === 'code'; });
                        logEntries = [];
                        i = 0;
                        _b.label = 2;
                    case 2:
                        if (!(i < executables.length)) return [3 /*break*/, 7];
                        block = executables[i];
                        lang = block.lang, content = block.content;
                        runner = CodeRunner.get(lang);
                        data = {
                            content: content,
                            env: env,
                            config: config,
                        ...
                        startedAt = Date.now();
                        return [4 /*yield*/, runner.preRun(data)];
                    case 3:
                        _b.sent();
                        return [4 /*yield*/, runner.run(data, opts)];
                    case 4:
                        _a = _b.sent(), result = _a.result, logs = _a.logs;
                        return [4 /*yield*/, runner.postRun(result, logs, data)];
                    case 5:
                        _b.sent();
                        logEntries.push({
                            teaser: "Block (".concat(lang, ") #").concat(i + 1, "/").concat(executables.length, "; Time: ").concat(Date.now() - startedAt, "ms."),
                            start: startedAt,
                            end: Date.now(),
                            block: i,
                            result: result,
                            logs: logs !== null && logs !== void 0 ? logs : [],
                        });
                        _b.label = 6;
                    case 6:
                        i++;
                        return [3 /*break*/, 2];
                    case 7: return [2 /*return*/, logEntries];
                }
            });
        });
    };
...
(function (CodeRunner) {
    var runners = [
        new JsonRunner_1.JsonRunner(),
        new YmlRunner_1.YmlRunner(),
        new JsRunner_1.JsRunner(),
        new ShellRunner_1.ShellRunner(),
    ];
    function get(lang) {
        var runner = runners.find(function (runner) { return runner.extensions.includes(lang); });
        return runner;
    }
    CodeRunner.get = get;
