...
import { str_interpolate } from './string';
...
export function obj_interpolate(obj, env: Record<string, any>, root?: AppConfig, isOptional?: boolean) {
    obj_visitStrings(obj, function (str, key, parent) {
        return str_interpolate(str, env, root);
    });
    return obj;
};
